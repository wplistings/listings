<?php if ( is_user_logged_in() ) : ?>
	...
	<fieldset>
		...
		<div class="field account-sign-in">
			...
			<a class="button" href="<?php echo apply_filters( 'submit_job_form_logout_url', wp_logout_url( get_permalink() ) ); ?>"><?php _e( 'Sign out', 'listings' ); ?></a>
		</div>
	</fieldset>
...
<?php else :
	...
	<fieldset>
		...
		<div class="field account-sign-in">
			<a class="button" href="<?php echo apply_filters( 'submit_job_form_login_url', wp_login_url( get_permalink() ) ); ?>"><?php _e( 'Sign in', 'listings' ); ?></a>
			...
			<?php elseif ( $account_required ) : ?>
				...
				<?php echo apply_filters( 'submit_job_form_login_required_message',  __('You must sign in to create a new listing.', 'listings' ) ); ?>
	...
	<?php if ( $registration_enabled ) : ?>
		<?php if ( ! $generate_username_from_email ) : ?>
			<fieldset>
				<label><?php _e( 'Username', 'listings' ); ?> <?php echo apply_filters( 'submit_job_form_required_label', ( ! $account_required ) ? ' <small>' . __( '(optional)', 'listings' ) . '</small>' : '' ); ?></label>
				<div class="field">
		...
		<?php endif; ?>
		<fieldset>
			<label><?php _e( 'Your email', 'listings' ); ?> <?php echo apply_filters( 'submit_job_form_required_label', ( ! $account_required ) ? ' <small>' . __( '(optional)', 'listings' ) . '</small>' : '' ); ?></label>
			<div class="field">

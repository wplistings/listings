<?php if ( is_user_logged_in() ) : ?>
	...
	<fieldset>
		...
		<div class="field account-sign-in">
			...
			<a class="button"
			   href="<?php echo apply_filters( 'listings_submit_form_logout_url', wp_logout_url( get_permalink() ) ); ?>"><?php _e( 'Sign out', 'listings' ); ?></a>
		</div>
	</fieldset>
...
<?php else :
	...
	<fieldset>
		...
		<div class="field account-sign-in">
			<a class="button"
			   href="<?php echo apply_filters( 'listings_submit_form_login_url', wp_login_url( get_permalink() ) ); ?>"><?php _e( 'Sign in', 'listings' ); ?></a>
	...
	<fieldset>
		...
		<div class="field">
			<input type="email" class="input-text" name="create_account_email" id="account_email"
			       placeholder="<?php esc_attr_e( 'you@yourdomain.com', 'listings' ); ?>"
